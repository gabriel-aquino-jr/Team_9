...
class _AppointmentTimeState extends State<AppointmentTime> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        const FancyText(ftext: 'Time Slots available', style: Style.header),
        ListTile(
          title: const Text('10:30AM'),
